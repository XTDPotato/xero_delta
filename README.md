...
> **医疗与装备素材权利提示**
>
> 本项目中医疗用品、药品、注射剂、修理包，以及头盔、防弹衣、胸挂、
> 背包等装备相关的图标、贴图、模型、外观设计、名称和标识，
> 可能涉及第三方著作权、商标或其他权利，相关权利归各自权利人所有。
> 本仓库未提供这些素材逐项核实的授权清单，不应将其视为已获授权的素材库。
> **代码采用 MIT 许可证，不代表第三方素材也按 MIT 授权。**
> 复制、修改、再分发或商业使用这些素材前，请自行核实来源和适用许可，
> 并在需要时取得权利人授权或替换为已获授权的素材。
> “学习用途”“非商业用途”和本提示本身都不代表已取得授权。
> **如您认为本项目内容侵犯了您的合法权益，请通过仓库可用的联系渠道告知，
> 并提供相关文件路径、原始作品及权属说明；核实后，我们将删除或替换相关内容。**
> 详见 [第三方声明](CREDITS.txt)。
...
本项目有权授权的软件代码与文档按现有 [MIT License](LICENSE) 发布。
该许可证不授予项目无权授予的第三方素材权利，尤其不应据此推定医疗、
装备类美术资源及相关名称、标识的授权状态。
Material Symbols 图标和第三方项目保留各自的许可证；
Minecraft、NeoForge 及外部模组不因本仓库发布而被重新授权。
本项目不因引用相关素材或名称而获得第三方官方认可或背书。
